...
cover: .gitbook/assets/2021-05-16_02.40.26.png
coverY: -63.50194552529183
---
...
Enjoy more fun gameplay & progression with the countless tweaks we've made to the normal Minecraft experience, from extra game sounds, quests, tree feller, vein miner, rideable enderpearls, realistic explosions, chest & inventory item sorting, raised enchantment level limits, and tons more.
...
In addition to our core smp, we offer an exclusive party games suite of over 20 minigames, a shared plotworld with unmetered WorldEdit, a large selection of community made parkour courses, a kit pvp arena, and more fun side modes for when you want a break from survival or want to fully dive into something else
