...
We offer an enhanced and more user friendly version of WorldEdit available in [creative plots](../../creative-plots/creative-plots.md) & the [parkour builder](../../parkour/parkour.md) to help you speed up your building. Advanced WE features like the clipboard, brushes, etc. are not available to encourage more unique, carefully composed handmade builds. With the abilities we've allowed, we hope to reduce annoying grunt work such as filling big areas with the same block, clearing out large amounts of blocks, and so forth.
