...
* (first) Joins/Disconnects
* Vibe [level](general/leveling.md) ups, [skill](survival/skill-leveling.md) level ups
* [Quest](survival/questing.md) completions
* [Chat games and coin flips](general/rich-chat/chat-games.md)
* [Skye](general/misc./skye.md)
* Advancements
* AFK change

The following is currently NOT forwarded from mc to discord chat sessions:
